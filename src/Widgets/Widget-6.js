...
export default function Widget6(props) {
  ...
  const first = () => {
    setDisplay(!Display);
    if (selectedData.data[0].color) {
      console.log(selectedData.data[0].color);
      setColor(selectedData.data[0].color);
    }
  ...
  return (
    ...
    >
      ...
      <Dialog
        ...
        style={{ width: "75%" }}
        // breakpoints={{ "960px": "75vw", "641px": "75vw" }}
      >
        <div className="">
          <div className="p-3">
            <p className="text-center p-2">
